...
from vectorproc.vector_indexer import VectorIndexer, Document
...
class SemanticSearchEngine:
    ...
    def _get_document_metadata(self, document_id: str) -> Dict[str, Any]:
        ...
        for doc_info in self.vector_indexer.document_registry.get("documents", {}).values():
            if doc_info.get("document_id") == document_id:
                return doc_info.get("metadata", {})
    ...
    def get_document_context(self, document_id: str, chunk_id: Optional[str] = None, window_size: int = 3) -> Dict[str, Any]:
        ...
        chunk_file_path = PROCESSED_DIR / document_entry.get("chunk_file", "")
